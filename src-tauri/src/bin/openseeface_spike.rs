...
fn main() -> Result<(), String> {
    ...
    if cfg.interactive { println!("Sit normally in front of the camera with your face clearly visible. Press Enter to begin tracking preflight."); let mut line = String::new(); io::stdin().read_line(&mut line).map_err(|e| e.to_string())?; }
